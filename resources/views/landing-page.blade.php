        ...
        <div class="row">
          <div class="col-lg-12">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Paket Make Up</li>
              <li data-filter=".filter-card">Paket Dekorasi</li>
              <li data-filter=".filter-web">Paket Wedding Organizer</li>
              <li data-filter=".filter-web">Paket Konsumsi</li>
            </ul>
          </div>
        </div>
