    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <ul class="nav navbar-nav">
                    <li>
                        <a href="{{URL('admin/dashboard')}}"><i class="menu-icon fa fa-laptop active"></i>Dashboard </a>
                    </li>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">{{$pegawai}}</span></div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">{{$paket}}</span></div>
                                            <div class="stat-heading">Jumlah Paket</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
