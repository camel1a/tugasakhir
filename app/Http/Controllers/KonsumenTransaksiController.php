...
class KonsumenTransaksiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pesanan = Pesanan::all();
        return view('konsumen\pesan-konsumen',compact('transaksi','pesanan'))->with('i');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('konsumen\pesan-konsumen')->with('success','Data Transaksi berhasil ditambah');
    }
    ...
    public function destroy($id)
    {
        try{
            ...
            $datas->delete();
            return redirect('konsumen\pesan-konsumen')->with('success','pesanan Berhasil Dihapus');
        }catch(\Throwable $th){
    ...
    public function cetak($id)
    {
        ...
        $pdf=PDF::loadview('konsumen.data-cetak',compact('transaksi', 'pesanan', 'konsumen'))->setPaper($customPaper);
